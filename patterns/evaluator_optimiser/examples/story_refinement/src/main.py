...
# Original source: https://github.com/openai/openai-agents-python/blob/25af629b3c877ba3d0e95189141bb636b21167a5/examples/agent_patterns/llm_as_a_judge.py
# See THIRD_PARTY_NOTICES.md at the repository root for the full license text.

"""Run an evaluator-optimiser loop that refines a story outline.

One agent generates an outline, a second agent judges it, and feedback is passed
back to the generator until the result passes or the retry limit is reached.
"""
