# research_report — Notebook

[workflow_planning-ko.ipynb](workflow_planning-ko.ipynb)에서 Agent 정의, 실행 흐름, 결과 확인, 작은 실습을 단계별로 진행합니다.

## 로컬 실행

1. [uv 환경 설정](../../../../../docs/setup.md)에 따라 커널을 준비합니다.
2. `workflow_planning-ko.ipynb`를 열고 `Agent Pattern Examples` 커널을 선택합니다.
